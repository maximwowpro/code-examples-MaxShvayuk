...
/* This file contains functions for working with EEPROM and key-management */
 ...
 * 0x00 - number of keys
 * 
 * 0x01 - 0x08 - root(admin) password
 * 
 * one key occupies 9 bytes:
...
/**
 * eeprom_write_user_key - writes a new 9-bytes user's key to EEPROM 
 */
...
/**
 * eeprom_delete_key - delete key with del_key_num number and relocate all others keys.
 */
